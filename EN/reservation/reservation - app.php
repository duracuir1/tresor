                ...
                <div class="info__column-right">
                    ...
                    <div class="dropdown lang-menu">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="../../FR/reservation/reservation - app.php">FR</a></li>
                            <!-- <li><a href="#">Es</a></li>
                            <li><a href="#">Ru</a></li> -->
                        </ul>
                    </div>
                ...
                <div class="col-sm-5 col-sm-push-7 col-md-4 col-md-push-8">
                    <div class="booking__details-body">
                        ...
                        <figure class="room__details">
                            ...
                            <figcaption>
                                <h3>Furnished flat</h3>
                                <div class="room__price">
                                    €133 (80.000 FCFA) <small>/ night</small>
                                </div>
                ...
                <div class="col-sm-7 col-sm-pull-5 col-md-8 col-md-pull-4">
                    <div class="reservation__form-body">
                        ...
                        <form class="reservation__form" data-animate-in="animateUp" action="" method="post">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label for="state" class="sr-only">State / Région</label>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="room-name" class="form-control" value="Furnished flat" style="visibility:hidden">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-sm-12">

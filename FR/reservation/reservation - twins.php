                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li>
                        ...
                        <!-- <ul class="dropdown-menu">
                            ...
                            <li><a href="../FR/room-detail.html">Detail Chambres</a></li>
                        </ul> -->
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="../FR/reservation.html">Réservation</a></li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="../FR/blog-item.html">Eléménts du Blog</a></li> -->
                ...
                <div class="col-sm-7 col-sm-pull-5 col-md-8 col-md-pull-4">
                    <div class="reservation__form-body">
                        ...
                        <form class="reservation__form" data-animate-in="animateUp" action="" method="post">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="room-name" class="form-control" value="Twins bed room" style="visibility:hidden">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <input type="submit" name="submit" class="btn btn-booking" value="Réservez maintenant">
                            </div>
                        </form>
                        <!-- .reservation__form -->
                    </div>
